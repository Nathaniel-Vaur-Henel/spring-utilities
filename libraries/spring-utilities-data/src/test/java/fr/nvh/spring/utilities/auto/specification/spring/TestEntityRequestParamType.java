...
public enum TestEntityRequestParamType implements RequestParamType {
    ...
    GLOBAL_EQUAL(null, OVER_SEARCH, EQUAL),
    STRING_EQUAL("string", OVER_SEARCH_INCLUDED, EQUAL),
    ANOTHER_STRING_EQUAL("anotherString", OVER_SEARCH_INCLUDED, EQUAL),
    ANOTHER_STRING_CONTAINING("anotherString", OVER_SEARCH_INCLUDED, CONTAINING),
    STRING_CONTAINING("string", OVER_SEARCH_EXCLUDED, CONTAINING),
    STRING_NOT_EQUAL("string", OVER_SEARCH_EXCLUDED, NOT_EQUAL),
    STRING_LIKE("string", OVER_SEARCH_EXCLUDED, LIKE),
    STRING_NOT_LIKE("string", OVER_SEARCH_EXCLUDED, NOT_LIKE),
    NUMBER_EQUAL("numberMultiplyBy5", OVER_SEARCH_EXCLUDED, EQUAL),
    NUMBER_NOT_EQUAL("numberMultiplyBy5", OVER_SEARCH_EXCLUDED, NOT_EQUAL),
    NUMBER_GREATER("numberMultiplyBy5", OVER_SEARCH_EXCLUDED, GREATER),
    NUMBER_GREATER_OR_EQUAL("numberMultiplyBy5", OVER_SEARCH_EXCLUDED, GREATER_OR_EQUAL),
    NUMBER_LESS("numberMultiplyBy5", OVER_SEARCH_EXCLUDED, LESS),
    NUMBER_LESS_OR_EQUAL("numberMultiplyBy5", OVER_SEARCH_EXCLUDED, LESS_OR_EQUAL),
    ;
    private final String fieldName;
    private final SpecificationParamType paramType;
    private final SpecificationOperator operator;

    TestEntityRequestParamType(String fieldName, SpecificationParamType paramType, SpecificationOperator operator) {
