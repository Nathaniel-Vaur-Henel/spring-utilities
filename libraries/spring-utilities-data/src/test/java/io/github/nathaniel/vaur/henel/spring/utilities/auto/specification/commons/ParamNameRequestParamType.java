...
public enum ParamNameRequestParamType implements RequestParamType {
    NAMED_PARAM_1("namedParam1", OVER_SEARCH_EXCLUDED, EQUAL, "named_param_1"),
    NAMED_PARAM_2("namedParam2", OVER_SEARCH_EXCLUDED, EQUAL, "named_param_2"),
    ;
    ...
    ParamNameRequestParamType(
            String fieldName, SpecificationParamType paramType, SpecificationOperator operator, String argumentName) {
    ...
    @Override
    public boolean isArgumentName(String argumentName) {
        return this.argumentName.equals(argumentName);
    }
}
