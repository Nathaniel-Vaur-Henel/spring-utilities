...
public interface TestConstants {
    ...
    String NOT_EXISTING_STRING_VALUE = "notExistingValue";
    String VALUE_1 = "value1";
    String VALUE_2 = "value2";
    String VALUE_3 = "value3";
    int TEST_ENTITY_COUNT = 5;
    int MAX_NUMBER_VALUE = (TEST_ENTITY_COUNT - 1) * 5;
    int MIN_NUMBER_VALUE = 0;
    int TOO_BIG_INTEGER_VALUE = 666;
    int TOO_SMALL_INTEGER_VALUE = -666;
}
