...
public enum PersonRequestParamType implements RequestParamType {
    ...
    FIRST_NAME("firstName", OVER_SEARCH_INCLUDED, EQUAL, "firstname", "first_name", "firstName"),
    LAST_NAME("lastName", OVER_SEARCH_INCLUDED, EQUAL, "lastname", "last_name", "lastName"),
    ...
    public boolean isArgumentName(String argumentName) {
        return httpArgumentNames.contains(argumentName);
    }
}
